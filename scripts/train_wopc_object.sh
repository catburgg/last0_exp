...
BASE_RUN_NAME="libero_object_query_kd0.1_ls16"
EXPERIMENT_NAME="libero_object_query"
OUTPUT_ROOT_DIR="../ckpt/${EXPERIMENT_NAME}/${BASE_RUN_NAME}"

DATA_JSON="/mnt/dataset/share/hwb/dataset/libero_training_data/libero_json/libero_object_no_noops_view2_chunk4_16_stride8_fast1_sparse_fastslow_train.json"
